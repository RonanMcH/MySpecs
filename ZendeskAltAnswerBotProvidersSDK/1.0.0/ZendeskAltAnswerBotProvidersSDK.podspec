Pod::Spec.new do |s|
  s.name         = "ZendeskAltAnswerBotProvidersSDK"
  s.version      = "1.0.0"
  ...
  s.source = { :http => 'https://zendesk.jfrog.io/zendesk/libs-releases-local/ios/zendesk/5.1.2/AnswerBotProvidersSDK/0.0.1/AnswerBotProvidersSDK.zip' }
